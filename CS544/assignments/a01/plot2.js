...
//
//  The code for the second visualization is contained in this file.
//  It is a scatter plot of the score.js  data. The ACT score is on the y-axis,
//  while the x-axis represents the total of the SAT scores. The circle's color corresponds 
//  to its GPA.
...
// making svg element and appending it to div2 element in index file
...
for (let i = 0; i < scores.length; i++) {
    ...
    circle.setAttributeNS(null, "cx", ((scores[i].SATM + scores[i].SATV) / 3.5) + 15);
    circle.setAttributeNS(null, "cy", (450 - (scores[i].ACT) * 12.3));
    circle.setAttributeNS(null, "r", scores[i].GPA);
    circle.setAttributeNS(null, "fill", get_color(scores[i].GPA));
    svg.appendChild(circle);
}


// Get color on the basis of GPA
...
//  X-Axis: Drawing Line
let x_axis_line = document.createElementNS("http://www.w3.org/2000/svg", "line");
x_axis_line.setAttributeNS(null, "x1", 25);
x_axis_line.setAttributeNS(null, "y1", 460);
x_axis_line.setAttributeNS(null, "x2", 460);
x_axis_line.setAttributeNS(null, "y2", 460);
x_axis_line.setAttributeNS(null, "stroke", "black");
svg.appendChild(x_axis_line);

// X-Axis: Adding tick marks 
for (let i = 0; i < 9; i++) {
    let x_axis_tick = document.createElementNS("http://www.w3.org/2000/svg", "line");
    x_axis_tick.setAttributeNS(null, "x1", 30 + i * 53.7);
    x_axis_tick.setAttributeNS(null, "y1", 460);
    x_axis_tick.setAttributeNS(null, "x2", 30 + i * 53.7);
    x_axis_tick.setAttributeNS(null, "y2", 470);
    x_axis_tick.setAttributeNS(null, "stroke", "black");
    svg.appendChild(x_axis_tick);
}

// X-Axis: Adding tick label 
for (let i = 0; i < 9; i++) {
    let x_axis_tick_label = document.createElementNS("http://www.w3.org/2000/svg", "text");
    x_axis_tick_label.setAttributeNS(null, "x", 30 + i * 53.7);
    x_axis_tick_label.setAttributeNS(null, "y", 480);
    x_axis_tick_label.setAttributeNS(null, "font-size", "10");
    x_axis_tick_label.setAttributeNS(null, "text-anchor", "middle");
    x_axis_tick_label.textContent = i * 200;
    svg.appendChild(x_axis_tick_label);
}
// X-Axis : Adding axis labels 
let x_label = document.createElementNS("http://www.w3.org/2000/svg", "text");
x_label.setAttributeNS(null, "x", 250);
x_label.setAttributeNS(null, "y", 495);
x_label.setAttributeNS(null, "font-size", "15");
x_label.setAttributeNS(null, "text-anchor", "middle");
x_label.textContent = "SAT";
svg.appendChild(x_label);


// Y-Axis: Drawing Line
let y_axis_line = document.createElementNS("http://www.w3.org/2000/svg", "line");
y_axis_line.setAttributeNS(null, "x1", 30);
y_axis_line.setAttributeNS(null, "y1", 15);
y_axis_line.setAttributeNS(null, "x2", 30);
y_axis_line.setAttributeNS(null, "y2", 470);
y_axis_line.setAttributeNS(null, "stroke", "black");
svg.appendChild(y_axis_line);


// Y-Axis: Adding tick marks 
for (let i = 0; i < 8; i++) {
    let y_axis_tick = document.createElementNS("http://www.w3.org/2000/svg", "line");
    y_axis_tick.setAttributeNS(null, "x1", 20);
    y_axis_tick.setAttributeNS(null, "y1", 15 + i * 63.55);
    y_axis_tick.setAttributeNS(null, "x2", 30);
    y_axis_tick.setAttributeNS(null, "y2", 15 + i * 63.55);
    y_axis_tick.setAttributeNS(null, "stroke", "black");
    svg.appendChild(y_axis_tick);
}

//Y-Axis: Adding tick marks 
for (let i = 0; i < 8; i++) {
    let y_axis_tick_label = document.createElementNS("http://www.w3.org/2000/svg", "text");
    y_axis_tick_label.setAttributeNS(null, "x", 25);
    y_axis_tick_label.setAttributeNS(null, "y", 25 + i * 63.5);
    y_axis_tick_label.setAttributeNS(null, "font-size", "10");
    y_axis_tick_label.setAttributeNS(null, "text-anchor", "end");
    y_axis_tick_label.textContent = (7 - i) * 5;
    svg.appendChild(y_axis_tick_label);
}

//Y-Axis: Adding axis marks 
let y_label = document.createElementNS("http://www.w3.org/2000/svg", "text");
y_label.setAttributeNS(null, "x", 15);
y_label.setAttributeNS(null, "y", 235);
y_label.setAttributeNS(null, "font-size", "15");
y_label.setAttributeNS(null, "text-anchor", "middle");
y_label.setAttributeNS(null, "transform", "rotate(-90, 17, 240)");
y_label.textContent = "ACT";
